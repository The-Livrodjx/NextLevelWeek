            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field">
                        ...
                        <input type="text" name="name" id="name" onChange={handleFunctionChange}/>
                    </div>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            ...
                            <input type="email" name="email" id="email" onChange={handleFunctionChange}/>
                        </div>

                        <div className="field">
                            <label htmlFor="whatsapp">Whatsapp</label>

                            <input type="text" name="whatsapp" id="whatsapp" onChange={handleFunctionChange}/>
                        </div>
